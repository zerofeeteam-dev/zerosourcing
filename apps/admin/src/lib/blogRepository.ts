...
const blogPostColumns =
  "id,status,type,slug,title,published_date,thumbnail_path,thumbnail_public_url,thumbnail_alt,content_mode,content,seo_description,landing_published,banner_published,landing_sections,banner_sections,created_at,updated_at,deleted_at";
