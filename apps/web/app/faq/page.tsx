...
import { CategoryNav, type FaqCategoryNavGroup } from "./CategoryNav";
...
const timelineFaqs = [
  {
    question: "개발 기간은 보통 얼마나 걸리나요?",
    answer:
      "MVP는 평균 4주 내외, 기업 홈페이지는 범위에 따라 3주 내외로 진행합니다. 앱스토어 심사가 필요한 앱은 심사 기간을 별도로 고려합니다.",
  },
  {
